...
export const DEFAULT_BASH_INTERCEPTOR_RULES: BashInterceptorRule[] = [
  ...
  },
  {
    ...
    tool: "find",
    message:
      "Use the `find` tool instead of find/fd. It respects .gitignore and is faster for glob patterns.",
  },
  {
...
export const SETTINGS_SCHEMA = {
  ...
  "edit.manageImports": {
    ...
    ui: {
      ...
      description:
        "Expose post-edit import/include management for the edit tool",
    },
  },
  ...
  "github.enabled": {
    ...
    ui: {
      ...
      label: "GitHub CLI",
      description:
        "Enable read-only gh_* tools for GitHub repository, issue, pull request, diff, and search access",
    },
  },
  ...
  "mcp.discoveryDefaultServers": {
    ...
    ui: {
      ...
      description:
        "Keep MCP tools from these servers visible while discovery mode hides other MCP tools",
    },
  },
